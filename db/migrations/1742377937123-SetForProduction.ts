...
export class SetForProduction1742377937123 implements MigrationInterface {
    name = 'SetForProduction1742377937123'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`student_profile\` (\`studentId\` varchar(36) NOT NULL, \`gradeLevel\` varchar(255) NULL, \`preferredSubjects\` text NULL, \`learningGoals\` text NULL, \`totalLessonsCompleted\` text NULL, \`averageQuizScore\` text NULL, \`badgesEarned\` text NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`userId\` varchar(36) NULL, UNIQUE INDEX \`REL_940639e2ce4b06e9857bbef0c9\` (\`userId\`), PRIMARY KEY (\`studentId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`teacher_profile\` (\`teacherId\` varchar(36) NOT NULL, \`bio\` text NULL, \`subjectsTaught\` text NULL, \`educationLevel\` varchar(255) NULL, \`teachingExperience\` int NULL, \`certifications\` text NULL, \`rating\` text NULL, \`totalCourses\` int NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`userId\` varchar(36) NULL, UNIQUE INDEX \`REL_73d2cd95a8ca63731f7a6bfbc0\` (\`userId\`), PRIMARY KEY (\`teacherId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`quiz\` (\`id\` varchar(36) NOT NULL, \`title\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`assessment\` json NOT NULL, \`duration\` int NOT NULL DEFAULT '0', \`courseId\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`downloadable_resources\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NULL, \`url\` varchar(255) NULL, \`type\` varchar(255) NULL, \`size\` bigint NULL, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`courseId\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`categories\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`imageUrl\` varchar(255) NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_8b0be371d28245da6e4f4b6187\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`courses\` (\`id\` varchar(36) NOT NULL, \`title\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`videoUrl\` varchar(255) NOT NULL, \`topics\` json NOT NULL, \`isOfflineAccessible\` tinyint NOT NULL DEFAULT 0, \`downloadCount\` int NOT NULL DEFAULT '0', \`lastSyncedAt\` datetime NULL, \`categoryId\` varchar(255) NULL, \`userId\` varchar(255) NOT NULL, \`duration\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`comment\` (\`id\` varchar(36) NOT NULL, \`content\` varchar(255) NOT NULL, \`courseId\` varchar(255) NOT NULL, \`userId\` varchar(255) NOT NULL, \`parentCommentId\` varchar(255) NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`notifications\` (\`id\` varchar(36) NOT NULL, \`recipientId\` varchar(255) NOT NULL, \`type\` enum ('SMS', 'EMAIL', 'SYSTEM') NOT NULL DEFAULT 'SYSTEM', \`title\` varchar(255) NOT NULL, \`content\` text NOT NULL, \`status\` enum ('PENDING', 'SENT', 'FAILED', 'READ') NOT NULL DEFAULT 'PENDING', \`phoneNumber\` varchar(255) NULL, \`metadata\` json NULL, \`isRead\` tinyint NOT NULL DEFAULT 0, \`readAt\` datetime NULL, \`sentAt\` datetime NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`quiz_submission\` (\`id\` varchar(36) NOT NULL, \`quizId\` varchar(255) NOT NULL, \`studentId\` varchar(255) NOT NULL, \`answers\` json NOT NULL, \`score\` float NOT NULL, \`totalQuestions\` int NOT NULL, \`correctAnswers\` int NOT NULL, \`isCompleted\` tinyint NOT NULL DEFAULT 1, \`timeTaken\` int NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`comment\` ADD CONSTRAINT \`FK_a96c50a5a085526d834b734ac4f\` FOREIGN KEY (\`courseId\`) REFERENCES \`courses\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`quiz_submission\` ADD CONSTRAINT \`FK_2f87562ee62457b540a828025d7\` FOREIGN KEY (\`studentId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`quiz_submission\` DROP FOREIGN KEY \`FK_2f87562ee62457b540a828025d7\``);
        ...
        await queryRunner.query(`ALTER TABLE \`comment\` DROP FOREIGN KEY \`FK_a96c50a5a085526d834b734ac4f\``);
