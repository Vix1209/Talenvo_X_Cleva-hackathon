...
export class SetForProduction1742294070688 implements MigrationInterface {
    name = 'SetForProduction1742294070688'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`student_profile\` (\`studentId\` varchar(36) NOT NULL, \`profilePicture\` varchar(255) NULL, \`gradeLevel\` varchar(255) NULL, \`preferredSubjects\` text NULL, \`learningGoals\` text NULL, \`totalLessonsCompleted\` text NULL, \`averageQuizScore\` text NULL, \`badgesEarned\` text NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`userId\` varchar(36) NULL, UNIQUE INDEX \`REL_940639e2ce4b06e9857bbef0c9\` (\`userId\`), PRIMARY KEY (\`studentId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`teacher_profile\` (\`teacherId\` varchar(36) NOT NULL, \`profilePicture\` varchar(255) NULL, \`bio\` text NULL, \`subjectsTaught\` text NULL, \`educationLevel\` varchar(255) NULL, \`teachingExperience\` int NULL, \`certifications\` text NULL, \`rating\` text NULL, \`totalCourses\` int NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`userId\` varchar(36) NULL, UNIQUE INDEX \`REL_73d2cd95a8ca63731f7a6bfbc0\` (\`userId\`), PRIMARY KEY (\`teacherId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`admin_profile\` (\`adminId\` varchar(36) NOT NULL, \`profilePicture\` varchar(255) NULL, \`lastLogin\` varchar(255) NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`userId\` varchar(36) NULL, UNIQUE INDEX \`REL_1a272d44c2214c1e8b22a886d6\` (\`userId\`), PRIMARY KEY (\`adminId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`quiz\` (\`id\` varchar(36) NOT NULL, \`title\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`assessment\` json NOT NULL, \`duration\` int NOT NULL DEFAULT '0', \`isPublished\` tinyint NOT NULL DEFAULT 0, \`courseId\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
